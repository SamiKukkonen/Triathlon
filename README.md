A full stack project for an activity tracker using the MERN-stack. The app has a functioning database for login authentication and user activity data storage.
